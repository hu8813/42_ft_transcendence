...
=======
    ...
    function newGButton() {
        ...
        button.addEventListener('click', function() {
            location.reload(); 
>>>>>>> 1b5e9d29436f5844d6c09f9d7967d71af73c5142:srcs/frontend/js/pong3.js
        });
...
>>>>>>> 1b5e9d29436f5844d6c09f9d7967d71af73c5142:srcs/frontend/js/pong3.js
        ...
        function showStartMessageWithCountdown(seconds) {
            if (seconds > 0) {
                ...
                // Player 1 controls
                ctx.fillText("Player 1", 20, canvas.height / 2 - 20);
                ctx.fillText("Use (W / S)", 20, canvas.height / 2 + 10);

                // Player 2 controls
                ctx.fillText("Player 2", canvas.width - 100, canvas.height / 2 - 20);
                ctx.fillText("Use (↑ / ↓)", canvas.width - 100, canvas.height / 2 + 10);

                // Player 3 controls
                ctx.fillText("Player 3", canvas.width / 2 - 100, canvas.height - 50);
                ctx.fillText("Use (Mouse)", canvas.width / 2 - 100, canvas.height - 30);

                // Game objective
                ctx.fillText("Whoever gets 7 goals loses", canvas.width / 2 - 140, canvas.height / 2 - 20);

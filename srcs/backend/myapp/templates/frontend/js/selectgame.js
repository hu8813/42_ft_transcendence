function showGameModes() {
    const cardsData = [
        {
            text: "Training (3D)",
            imgPlaceholder: '/static/src/cpu.jpeg',
            href: "#player3d1",
        },
        {
            text: "Single Player (against CPU)",
            imgPlaceholder: '/static/src/playagainst.jpeg',
            href: "#playerai1",
        },
        {
            text: "Multiplayer 2 Players (local)",
            imgPlaceholder: '/static/src/tournament.jpeg',
            href: "#pongehab",
        },
        {
            text: "Multiplayer 3 Players (local)",
            imgPlaceholder: '/static/src/multiplayer.jpeg',
            href: "#pong3",
        },
        {
